...
@section('content')
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-center text-md-start px-4">
                ...
                <div class="d-flex justify-content-center justify-content-md-start gap-3">
                    <a href="/cars" class="btn btn-primary fw-bold px-4">
                        View Cars
                    </a>
                    <a href="/contact_us" class="btn btn-outline-primary px-4">
                        Contact Us
                    </a>
                </div>
            </div>
    ...
    <div class="container my-5">
        ...
        <div class="d-flex justify-content-end me-md-5 me-2 mt-3">
            <a href="/cars" class="btn btn-outline-primary btn-sm">
                See All
            </a>
        </div>
    </div>
...
<div class="container my-5">
    ...
    <div class="bg-dark text-white rounded p-4 mt-4 d-flex flex-column flex-md-row justify-content-between align-items-center gap-4">
        ...
        <div class="text-center border-bottom border-md-bottom-0 border-md-end pb-3 pb-md-0 px-md-4 flex-fill">
            ...
            <p class="fs-5 font-car">Satisfied Client</p>
        </div>

 <div class="text-center border-bottom border-md-bottom-0 border-md-end pb-3 pb-md-0 px-md-4 flex-fill">
            <h3 class="fs-1 fw-medium font-car text-primary">500</h3>
            <p class="fs-5 font-car">Reservation</p>
        </div>
    </div>
</div>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="bg-white shadow-sm rounded-4 p-4 h-100 text-center transition-hover">
                    ...
                    <h5 class="fw-bold text-dark">Flexible Payment</h5>
                    <p class="text-muted small">Choose from multiple payment options designed to fit your lifestyle and schedule.</p>
                </div>
            </div>
        </div>
    </div>
